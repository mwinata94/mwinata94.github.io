function colorTransform(selector, styleType, startColor, endColor, frameCount = 32) {
	...
	if ((sR == 0 && eR != 0) || sR != 0 && eR == 0) offsetR += (offsetR < 0) ? -1 : 1;
	if ((sG == 0 && eG != 0) || sG != 0 && eG == 0) offsetG += (offsetG < 0) ? -1 : 1;
	if ((sB == 0 && eB != 0) || sB != 0 && eB == 0) offsetB += (offsetB < 0) ? -1 : 1;
	// Store intervalRGB
